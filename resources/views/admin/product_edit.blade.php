          ...
          <div class="col-lg-6">
            ...
            <div class="card card-primary">
              ...
              <form action="{{ route('product_update') }}" method="post" enctype="multipart/form-data">
                ...
                <br>
                <img id="preimage" src="{{ URL::to('/') }}/images/{{$product->photo}}" height="120px" >
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="inputName" placeholder="Name of the product" value="{{ $product->name }}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="price" class="form-control" id="inputPrice" placeholder="Price of the product" value="{{ $product->price }}">
                  </div>
                  ...
                  <!-- description -->
                   <div class="form-group">
                    ...
                    <textarea type="text" name="description" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $product->description }}</textarea>
                  </div>
